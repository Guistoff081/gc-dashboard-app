...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { : @venda., clientes_id: @venda.clientes_id, cvalor_total: @venda.cvalor_total, keys: @venda.keys, produtos_id: @venda.produtos_id } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { : @venda., clientes_id: @venda.clientes_id, cvalor_total: @venda.cvalor_total, keys: @venda.keys, produtos_id: @venda.produtos_id } }
