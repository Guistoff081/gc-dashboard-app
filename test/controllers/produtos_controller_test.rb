...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { nome: @produto.nome, quantidade: @produto.quantidade, tipo: @produto.tipo, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { nome: @produto.nome, quantidade: @produto.quantidade, tipo: @produto.tipo, valor: @produto.valor } }
